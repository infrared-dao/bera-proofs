        ...
        try:
            ...
            if prev_state_root is None or prev_block_root is None:
                (
                    fetched_state_root,
                    fetched_block_root,
                ) = self.beacon_client.get_historical_roots(current_slot)
                ...
                logger.info(
                    f"Auto-fetched historical data: state_root={prev_state_root}, block_root={prev_block_root}"
                )
            ...
            try:
                ...
                result = generate_validator_proof(
                    temp_file, val_index, prev_state_root, prev_block_root
                )
            finally:
